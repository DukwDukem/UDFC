...
public class RoundTube extends Tube implements CalcTube {

	public static final String[] ROUND = {};
	
	private Round_Tube stockTube;



	public RoundTube(double tubeLength2, Round_Tube stockTube) {
		super(tubeLength2);
	...
	public double surfaceArea(int qty){
		double area = this.stockTube.getDim()*Math.PI*this.getTubeLength()/144;
		int precision = 10000;
	...
	public Round_Tube getStockTube() {
		return stockTube;
	}


	public void setStockTube(Round_Tube stockTube) {
		this.stockTube = stockTube;
	}
